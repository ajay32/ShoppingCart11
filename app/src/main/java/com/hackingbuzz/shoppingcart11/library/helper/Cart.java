...
import com.hackingbuzz.shoppingcart11.library.exception.ProductNotFoundException;
import com.hackingbuzz.shoppingcart11.library.exception.QuantityOutOfRangeException;
...
public class Cart implements Serializable {
    ...
    public void add(final Saleable sellable, int quantity) {
        ...
        // depending on the proudct and its quantities...we creating total price ..and total quantity ..n we created a method..tht gonna return total price where we needed it..find that method below
