...
public class CartItemAdapter extends BaseAdapter {
    ...
    @Override
    public CartItem getItem(int position) {  //return the item clicked
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        tvName.setText(cartItem.getProduct().getpName());
        ...
        // getCost method takes Product...n return that product total cost based on its quantiity..
